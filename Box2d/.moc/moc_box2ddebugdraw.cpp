...
**
** Created: Wed Jan 23 11:48:04 2013
...
static const char qt_meta_stringdata_Box2DDebugDraw[] = {
    "Box2DDebugDraw\0\0onWorldStepped()\0"
    "Box2DWorld*\0world\0"
};
...
void Box2DDebugDraw::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onWorldStepped(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Box2DDebugDraw::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Box2DDebugDraw::staticMetaObject = {
    { &QDeclarativeItem::staticMetaObject, qt_meta_stringdata_Box2DDebugDraw,
      qt_meta_data_Box2DDebugDraw, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Box2DDebugDraw::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Box2DDebugDraw))
