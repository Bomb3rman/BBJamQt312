...
Box2DFixture::Box2DFixture(QDeclarativeItem *parent) :
    ...
    mFixture(0)
{
    connect(this, SIGNAL(heightChanged()), this, SLOT(recreateShape()));
    connect(this, SIGNAL(widthChanged()), this, SLOT(recreateShape()));
}
...
void Box2DFixture::emitPostSolve(Box2DFixture *other, float value)
{
    emit postSolve(other, value);
}

void Box2DFixture::recreateShape()
{
    if (body)
        createFixture(body);
}
